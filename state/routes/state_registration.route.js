...
const absenMiddleware = require('../middleware/state.middleware')
...
module.exports = function(app) {
    ...
    app.put(
        ...
        absenMiddleware.openAbsenAwal, absenMiddleware.closeAbsenAwal,
        middleware.verifyJWT, middleware.isMahasiswa,
    ...
    app.put(
        ...
        toggle.presensi, toggle.checkToggle,
        absenMiddleware.openAbsenAkhir, absenMiddleware.closeAbsenAkhir,
        middleware.verifyJWT, middleware.isMahasiswa,
